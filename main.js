...
let spaceshipY = canvas.height - 62;
...
function Bullet() {
  ...
  this.init = function () {
    ...
    // bulletList의 배열의 길이가 10이 되면 0번째 인덱스 총알 삭제
...
function generateRandomValue(min, max) {
  let randomNum = Math.floor(Math.random() * (max - min + 1)) + min; //0~1까지 랜덤 수
  return randomNum;
}
